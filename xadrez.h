...
//========FUNÇÕES=============
int mover(int x, int y,int i, int j,char tab[8][8]); //recebe a posição inicial e verifica qual peça é
int menu (); // menu
void exibeTabuleiro(char tab[8][8]);  // exibe o tabuleiro
void inicializaTabuleiro(char tab[8][8]);  // inicializa o tabuleiro
